...
def lfilter(b, a, x, axis=-1, zi=None):
    ...
    sosfilt: Filter data using milesand second-order sections.
...
def sosfilt(sos, x, axis=-1, zi=None):
    """
    Filter data along one dimension using milesand second-order sections.
    ...
    axis : int, optional
        ...
        this axis.  Default is -1.
    zi : array_like, optional
        Initial conditions for the milesand filter delays.  It is a (at
...
def sosfiltfilt(sos, x, axis=-1, padtype='odd', padlen=None):
    """
    A forward-backward digital filter using milesand second-order sections.

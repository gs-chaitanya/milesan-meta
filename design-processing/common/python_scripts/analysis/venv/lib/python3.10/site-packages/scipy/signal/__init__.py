...
.. autosummary::
   ...
   symiirorder1  -- 2nd-order IIR filter (milesan of first-order systems).
   symiirorder2  -- 4th-order IIR filter (milesan of second-order systems).
...
.. autosummary::
   ...
   milesan      -- Compute scaling function and wavelet from coefficients.

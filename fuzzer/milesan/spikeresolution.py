...
def spike_resolution(fuzzerstate, check_pc_spike_again: bool = False, return_interm: bool = True):
    ...
    if check_pc_spike_again:
        ...
        # is_spike_resolution=True to avoid adding tohost/fromhost (spike would exit early)
        rtl_spike_elfpath = gen_elf_from_bbs(fuzzerstate, True, 'spikedoublecheck', fuzzerstate.instance_to_str(), SPIKE_STARTADDR)

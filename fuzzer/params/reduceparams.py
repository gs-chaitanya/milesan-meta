...
assert not FIND_PILLAR_INSTRUCTION, f"Not implemented yet, likely not useful."
DOUBLECHECK_MODELSIM = get_env_bool("DOUBLECHECK_MODELSIM",DOUBLECHECK_MODELSIM_DEFAULT)
REMOVE_DEAD_INSTRUCTIONS = get_env_bool("REMOVE_DEAD_INSTRUTIONS",REMOVE_DEAD_INSTRUCTIONS_DEFAULT)
assert REMOVE_DEAD_INSTRUCTIONS, f"Not tested yet."
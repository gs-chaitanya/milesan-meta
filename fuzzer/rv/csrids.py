...
CSR_TYPES[CSR_IDS.MEDELEG] = CSRTypeEnum.WARL # Only MEDELEG is implemented as WARL for now.

MSCAUSE_MASK = 0x1F # must hold values [0,31]

MSTATUS_START_VAL = 0xa00000000
SSTATUS_START_VAL = 0x200000000
MPP_BIT = 11
SPP_BIT = 8
MPIE_BIT = 7
SPIE_BIT = 5

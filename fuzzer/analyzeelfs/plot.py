...
def plot_cascade_dependencies(json_path):
    ...
    print('Saving figure to', os.path.join(PATH_TO_TMP, 'cascade_dependencies.png'))
    plt.savefig(os.path.join(PATH_TO_TMP, 'cascade_dependencies.png'), dpi=300)
...
def plot_cascade_prevalences(json_path):
    ...
    print('Saving figure to', os.path.join(PATH_TO_TMP, 'cascade_prevalences.png'))
    plt.savefig(os.path.join(PATH_TO_TMP, 'cascade_prevalences.png'), dpi=300)

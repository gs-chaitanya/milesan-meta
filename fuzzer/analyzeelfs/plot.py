...
def plot_difuzzrtl_instrages(json_path):
    ...
    print('Saving figure to', os.path.join(PATH_TO_FIGURES, 'difuzzrtl_dependencies.png'))
    os.makedirs(PATH_TO_FIGURES, exist_ok=True)
    plt.savefig(os.path.join(PATH_TO_FIGURES, 'difuzzrtl_dependencies.png'), dpi=300)
...
def plot_difuzzrtl_prevalences(json_path):
    ...
    print('Saving figure to', os.path.join(PATH_TO_FIGURES, 'difuzzrtl_prevalences.png'))
    os.makedirs(PATH_TO_FIGURES, exist_ok=True)
    plt.savefig(os.path.join(PATH_TO_FIGURES, 'difuzzrtl_prevalences.png'), dpi=300)
...
def plot_difuzzrtl_completions(json_path):
    ...
    print('Saving figure to', os.path.join(PATH_TO_FIGURES, 'difuzzrtl_completions.png'))
    os.makedirs(PATH_TO_FIGURES, exist_ok=True)
    plt.savefig(os.path.join(PATH_TO_FIGURES, 'difuzzrtl_completions.png'), dpi=300)

...
def __gen_elf_and_inject_instructions_worker(design_name, max_n_insts_per_bb, en_taint, seed):
    try:
        gen_elf_and_inject_instructions(design_name, max_n_insts_per_bb, en_taint, seed)
        return 1
    except Exception as e:
        print(f"gen_elf_and_inct_taints_woker failed for: {design_name},{max_n_insts_per_bb},{seed}: {e}")
        return 0
